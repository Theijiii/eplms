...
const validateStep = (step, formData) => { const isEmpty = (value) => value === undefined || value === null || value === '' || (Array.isArray(value) && value.length === 0); 
const stepFields = { 
...
const missing = []; stepFields[step].forEach(field => { if (isEmpty(formData[field])) missing.push(field.replace(/_/g,' ').replace(/\b\w/g, c => c.toUpperCase())); }); if (missing.length) return { ok: false, message: "Missing: " + missing.join(", ") }; return { ok: true }; };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          >
            ...
            <option value="Professional Electrical Engineer">
              Professional Electrical Engineer
            </option>
            <option value="Professional Electronics Engineer">
              Professional Electronics Engineer
            </option>
            <option value="Professional Mechanical Engineer">
              Professional Mechanical Engineer
            </option>
            <option value="Registered Electrical Engineer">
        ...
        <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3 p-3 border rounded w-full bg-white">
              <Upload className="w-5 h-5 text-gray-500" /> {/* ✅ Icon applied here */}
              <input
                type="file"
                name="signature"
                onChange={handleChange}
...
const Field = ({ name, placeholder, type, value, onChange, className }) => (
